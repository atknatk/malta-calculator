...
const RETIREMENT_AGE_BRACKETS = [
    { maxBirthYear: 1951, maleAge: 61, femaleAge: 60, description: "Born 1951 or earlier" },
 ...
 */
export function calculateRetirementAge(input: RetirementAgeInput): RetirementAgeOutput {
    ...
    const bracket = RETIREMENT_AGE_BRACKETS.find((b) => birthYear <= b.maxBirthYear);
