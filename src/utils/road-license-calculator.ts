 ...
 */
export function calculateRoadLicense(
  input: RoadLicenseInput,
): RoadLicenseOutput {
  const {
    engineCapacity,
    co2Emissions,
  ...
  else if (licensePeriod === 6)
    periodMultiplier = 0.55; // 5% savings
  ...
  if (fuelType === "electric") {
    ...
    description =
      "Vintage vehicles (25+ years) enjoy a reduced flat rate of €30 per year.";
  } else {
