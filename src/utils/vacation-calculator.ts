 ...
 */
export function calculateVacationLeave(input: VacationLeaveInput): VacationLeaveOutput {
    ...
    const publicHolidayHours = Math.round(publicHolidaysOnWeekends * HOURS_PER_DAY * hoursRatio);
