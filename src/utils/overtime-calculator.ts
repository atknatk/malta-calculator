 ...
 */
const OVERTIME_MULTIPLIERS: Record<OvertimeType, { rate: number; description: string }> = {
    weekday: {
        rate: 1.5,
...
export function getOvertimeRates() {
    return [
        { type: "weekday" as OvertimeType, label: "Weekday", rate: "1.5×", percent: "150%" },
        { type: "sunday" as OvertimeType, label: "Sunday/Rest Day", rate: "2.0×", percent: "200%" },
        { type: "holiday" as OvertimeType, label: "Public Holiday", rate: "2.0×", percent: "200%" },
    ];
}
