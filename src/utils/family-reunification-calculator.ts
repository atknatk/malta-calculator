...
export function calculateFamilyReunification(
    ...
    if (scheme === "family-reunification") {
        ...
        const percentagePerMember = 20;
        const perMemberAddition = WAGE_DATA.medianWageNet * (percentagePerMember / 100);
        const totalAddition = perMemberAddition * familyMemberCount;
        const minimumRequired = baseWage + totalAddition;
        ...
        return {
            ...
            source: "https://identita.gov.mt/expatriates-unit-main-page/noneu-nationals/non-employment-permits/family-members-policy/",
        };
    }
}
...
export function getSchemeInfo(scheme: SchemeType): {
    ...
    return {
        ...
        incomeType: "net",
        sourceUrl: "https://identita.gov.mt/expatriates-unit-main-page/noneu-nationals/non-employment-permits/family-members-policy/",
    };
}
