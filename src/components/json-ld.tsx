...
export function OrganizationJsonLd() {
  const jsonLd = {
    ...
    description:
      "Malta's most trusted salary calculator. Free tools for calculating net salary, taxes, SSC contributions, and more.",
    foundingDate: "2024",
    areaServed: {
      "@type": "Country",
      name: "Malta",
    ...
    itemListElement: [
      {
        ...
        description:
          "Calculate your Malta net salary with accurate tax, SSC, and COLA",
        url: `${SITE_URL}/salary`,
      },
      {
        "@type": "SiteNavigationElement",
...
export function WebsiteJsonLd() {
  const jsonLd = {
    ...
    url: SITE_URL,
    description:
      "Free Malta salary calculator with accurate 2024-2026 tax rates, SSC contributions, and COLA calculations.",
    potentialAction: {
      "@type": "SearchAction",
      target: {
        "@type": "EntryPoint",
