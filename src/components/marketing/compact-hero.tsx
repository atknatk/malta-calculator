            ...
            >
                ...
                >
                    <div className="flex items-center gap-2">
                        <div className="text-lg md:text-xl font-bold text-gradient">2024-26</div>
                        <div className="text-xs text-muted-foreground">Tax Years</div>
                    </div>
                    <div className="w-px h-4 bg-border" />
                    <div className="flex items-center gap-2">
                        <div className="text-lg md:text-xl font-bold text-gradient-secondary">100%</div>
                        <div className="text-xs text-muted-foreground">Accurate</div>
                    </div>
                    <div className="w-px h-4 bg-border" />
                    <div className="flex items-center gap-2">
                        <div className="text-lg md:text-xl font-bold text-gradient">Free</div>
