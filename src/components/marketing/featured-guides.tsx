...
const featuredGuides: GuideCard[] = [
  {
    ...
    description:
      "Complete guide to income tax brackets for single, married, and parent taxpayers.",
    category: "Tax Guide",
    readTime: "8 min",
  },
  {
    ...
    description:
      "Social Security rates, weekly caps, and the 1962 age threshold explained.",
    category: "SSC Guide",
    readTime: "6 min",
  },
  {
    ...
    description:
      "Current rates at €213.54/week and National Minimum Wage regulations.",
    category: "Salary",
    readTime: "5 min",
  },
  {
    ...
    description:
      "Cost of Living Adjustment and how it affects your Malta salary.",
    category: "Salary",
    readTime: "5 min",
  },
  {
...
export function FeaturedGuides() {
  return (
    <section className="w-full py-8" aria-label="Malta Tax and Salary Guides">
      {/* Section Header */}
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto text-sm">
          In-depth guides on Malta&apos;s tax system, employment regulations,
