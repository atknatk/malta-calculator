      ...
      <main role="main" aria-label="Terms of Service">
        <Shell className="max-w-4xl py-12">
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <section
              id="acceptance"
              className="mb-10 pb-8 border-b border-border/50"
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using the Malta Calculator website
                (&quot;Service&quot;), you accept and agree to be bound by these
              ...
              <p className="text-muted-foreground leading-relaxed mt-4 p-4 bg-muted/30 rounded-lg border-l-4 border-primary/50">
                <strong>🇲🇹 Malti:</strong> Meta taċċessa u tuża l-websajt Malta
                Calculator, taċċetta u taqbel li tkun marbut b&apos;dawn
                it-Termini ta&apos; Servizz.
              </p>
            </section>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                Malta Calculator provides free online tools for calculating
                financial, tax, and employment-related matters specific to
                Malta, including:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-4 ml-4">
                <li>
                  <strong>Salary & Tax:</strong> Net salary, income tax, SSC
                  contributions
                </li>
                <li>
                  <strong>Vehicle:</strong> VRT, road license, driver license
                  fees
                </li>
                <li>
                  <strong>Property:</strong> Stamp duty, rental tax, first-time
                  buyer exemptions
                </li>
                <li>
                  <strong>Employment:</strong> Notice period, vacation,
                  overtime, sick leave
                </li>
                <li>
                  <strong>Banking:</strong> Mortgage, personal loan, savings
                  interest
                </li>
                <li>
                  <strong>Benefits:</strong> Children&apos;s allowance, in-work
                  benefit, childcare
                </li>
              </ul>
              <p className="text-muted-foreground leading-relaxed mt-4">
                All calculations are for{" "}
                <strong>informational purposes only</strong> and should not be
                relied upon for official purposes.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Malta Calculator offers event registration services that require
                user authentication. By registering for events:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-2 ml-4">
                ...
                <li>
                  You consent to receiving event-related communications via
                  email
                </li>
                <li>
                  You understand that event details may be shared with event
                  organizers
                </li>
              </ul>
              ...
              <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg mt-2">
                <p className="text-blue-700 dark:text-blue-300">
                  🔐 <strong>Third-Party Authentication:</strong> We use Google
                  Sign-In for secure authentication. By using this feature:
                </p>
                <ul className="list-disc list-inside text-blue-700 dark:text-blue-300 mt-2 text-sm space-y-1">
                  <li>
                    You authorize us to receive your basic profile information
                    from Google
                  </li>
                  <li>
            ...
            >
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-4 ml-4">
                <li>
                  Calculations may not always be accurate, complete, or
                  up-to-date
                </li>
                <li>
                  Tax rates and regulations are subject to change by the
                  Government of Malta
                </li>
                <li>We cannot guarantee real-time accuracy</li>
                <li>
                  Always verify critical calculations with official sources
                  (CFR, Transport Malta, DIER)
                </li>
              </ul>
            </section>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                Malta Calculator shall not be liable for any indirect,
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-4 ml-4">
                ...
                <li>
                  Financial losses resulting from reliance on calculations
                </li>
              ...
              <div className="mt-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                <p className="text-blue-700 dark:text-blue-300">
                  💡 <strong>Recommendation:</strong> For important financial
                  decisions, consult with qualified professionals such as
                  accountants, tax advisors, or legal counsel in Malta.
                </p>
              </div>
            </section>
            ...
            <section id="ip" className="mb-10 pb-8 border-b border-border/50">
              ...
              <p className="text-muted-foreground leading-relaxed">
                All content, features, design elements, and intellectual
                property on the Service are owned by Malta Calculator and
                protected by copyright laws.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
                <strong>Permitted:</strong> Personal, non-commercial use;
                sharing links; printing results for personal use.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-2">
                <strong>Not Permitted:</strong> Copying, modifying,
                distributing, or selling any part of the Service without
                permission.
              </p>
            </section>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                laws of Malta. Any disputes shall be subject to the exclusive
                jurisdiction of the courts of Malta.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4 p-4 bg-muted/30 rounded-lg border-l-4 border-primary/50">
                <strong>🇲🇹 Malti:</strong> Dawn it-Termini huma ggvernati
                mil-liġijiet ta&apos; Malta. Kwalunkwe tilwima tkun soġġetta
                għall-ġurisdizzjoni esklużiva tal-qrati ta&apos; Malta.
              </p>
            </section>
            ...
            <section className="mt-8 p-6 bg-gradient-to-br from-primary/5 via-background to-secondary/5 rounded-2xl border border-primary/10 text-center">
              <p className="text-muted-foreground mb-2">
                By using Malta Calculator, you acknowledge that you have read,
                understood, and agree to these Terms.
              </p>
              <p className="text-sm text-muted-foreground">
                Document version: 2.0 | © 2024-2026 Malta Calculator
              </p>
            </section>
          </article>
        </Shell>
