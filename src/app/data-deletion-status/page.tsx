        ...
        <Shell className="max-w-2xl py-12">
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="font-cal text-3xl md:text-4xl font-bold mb-4">
            ...
            <div className="p-6 bg-gradient-to-br from-emerald-500/10 via-background to-blue-500/10 rounded-2xl border border-emerald-500/20 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Any data associated with your Facebook account has been deleted
                from our systems.
              </p>
              <div className="p-4 bg-muted/50 rounded-lg text-left">
                <h3 className="text-sm font-semibold mb-2 !mt-0">
                  What was deleted:
                </h3>
            ...
            <div className="mt-8 p-4 bg-muted/30 rounded-lg">
              <h3 className="text-base font-semibold mb-2 !mt-0">
                About Data Deletion
              </h3>
              <p className="text-sm text-muted-foreground">
                Malta Calculator uses Clerk for authentication. When you request
                data deletion through Facebook, we remove any Facebook-specific
                identifiers from our system. Your calculator usage data is never
