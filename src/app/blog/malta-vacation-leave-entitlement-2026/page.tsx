...
export const metadata: Metadata = {
  ...defaultMetadata,
  title:
    "Malta Vacation Leave 2026: Annual Leave Entitlement Guide | Malta Calculator",
  description:
    "Malta vacation leave guide for 2026. Minimum 192 hours (24 days) annual leave entitlement plus public holiday additions.",
  keywords: [
    "Malta vacation leave",
    "Malta annual leave",
    "Malta holiday entitlement",
    "Malta 192 hours leave",
  ],
  alternates: pageAlternates("/blog/malta-vacation-leave-entitlement-2026"),
  openGraph: {
    ...ogMetadata,
    title: "Malta Vacation Leave 2026: Complete Guide",
    url: `${SITE_URL}/blog/malta-vacation-leave-entitlement-2026`,
    type: "article",
    images: [getBlogOgImage("Malta Vacation Leave 2026: Complete Guide")],
  },
  twitter: {
    ...twitterMetadata,
    title: "Malta Vacation Leave 2026: Complete Guide",
        ...
        <Shell className="max-w-4xl py-12">
          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <section id="overview">
              ...
              <p>
                In Malta, full-time employees working a standard 40-hour week
                are entitled to a minimum of <strong>192 working hours</strong>{" "}
                (equivalent to 24 working days at 8 hours per day) of annual
                vacation leave.
              </p>
            </section>
                ...
                <table className="w-full border-collapse text-sm">
                  <thead>
                    <tr className="bg-muted">
                      <th className="border border-border p-3">Component</th>
                      <th className="border border-border p-3">Hours</th>
                      <th className="border border-border p-3">Days</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr className="bg-muted/50">
                      <td className="border border-border p-3">
                        Public Holidays on Weekends (2026: 3)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-border p-3 font-bold">27</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section id="public-holidays" className="mt-12">
              ...
              <p>
                When a public holiday falls on a weekend (Saturday or Sunday),
                employees receive additional vacation hours:
              </p>
              <ul>
                <li>
                  <strong>2024:</strong> 3 holidays on weekends → +24 hours
                </li>
                <li>
                  <strong>2025:</strong> 2 holidays on weekends → +16 hours
                </li>
                <li>
                  <strong>2026:</strong> 3 holidays on weekends → +24 hours
                </li>
              </ul>
            </section>
            ...
            <section id="part-time" className="mt-12">
              ...
              <p>
                Part-time employees receive vacation leave on a{" "}
                <strong>pro-rata basis</strong>. The calculation is:
              </p>
              <div className="p-4 bg-muted/30 rounded-xl not-prose my-4">
                <code>
                  Part-time hours ÷ 40 hours × Full-time entitlement = Your
                  entitlement
                </code>
              </div>
              <p>
                For example, a 20-hour/week employee would receive 96 base hours
                (50% of 192).
              </p>
            </section>
            ...
            <section id="carryover" className="mt-12">
              ...
              <ul>
                <li>
                  Up to <strong>50%</strong> of unused leave may be carried
                  forward
                </li>
