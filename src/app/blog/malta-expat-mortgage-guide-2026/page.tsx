...
export const metadata: Metadata = {
  ...defaultMetadata,
  title:
    "Malta Expat Mortgage Guide 2026: AIP Permit, Residency & Stamp Duty | Malta Calculator",
  description:
    "Complete guide for expats buying property in Malta 2026. Learn about AIP permit requirements, 5-year residency rule, 5% stamp duty (1%+4%), and first-time buyer exemptions.",
  keywords: [
    "Malta expat mortgage",
    "AIP permit Malta",
    "Malta expat property",
    "Malta residency property",
    "Malta stamp duty expat",
    "Malta foreign buyer",
  ],
  alternates: pageAlternates("/blog/malta-expat-mortgage-guide-2026"),
  openGraph: {
    ...ogMetadata,
          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            <header className="mb-12 not-prose">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Everything expats need to know about buying property and getting
                a mortgage in Malta.
              </p>
            </header>
            ...
            <section id="overview">
              ...
              <p>
                Yes, expats can obtain mortgages in Malta, but the process
                involves additional requirements compared to Maltese citizens.
                Banks typically require a <strong>20-30% deposit</strong>{" "}
                (compared to 10% for residents) and you may need special permits
            ...
            <section id="residency-rule" className="mt-12">
              ...
              <div className="p-6 bg-amber-500/10 rounded-xl not-prose my-6 border border-amber-500/20">
                ...
                <p className="text-muted-foreground">
                  If you have resided in Malta for{" "}
                  <strong>less than 5 years</strong> (e.g., 3.5 years), you will
                  need to obtain an{" "}
                  <strong>
                    AIP (Acquisition of Immovable Property) Permit
                  </strong>{" "}
                  to purchase property outside Special Designated Areas (SDAs).
                </p>
              </div>
              <p>The residency requirements work as follows:</p>
              <ul>
                <li>
                  <strong>EU/EEA Citizens with 5+ years residency:</strong> No
                  AIP permit required
                </li>
                <li>
                  <strong>EU/EEA Citizens with less than 5 years:</strong> AIP
                  permit required for secondary residences
                </li>
                <li>
                  <strong>Non-EU/EEA Citizens:</strong> Always require AIP
                  permit for properties outside SDAs
                </li>
              </ul>
            </section>
            ...
            <section id="aip-permit" className="mt-12">
              ...
              <div className="p-6 bg-blue-500/10 rounded-xl not-prose my-6">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li>
                    • <strong>Cost:</strong> €233
                  </li>
                  <li>
                    • <strong>Processing Time:</strong> Approximately 35 days
                  </li>
                  <li>
                    • <strong>Restriction:</strong> Usually limits you to one
                    property
                  </li>
                  <li>
                    • <strong>Rental:</strong> Cannot rent out the property
                  </li>
                </ul>
              </div>
            ...
            <section id="stamp-duty" className="mt-12">
              ...
              <p>
                When purchasing property in Malta, you must pay{" "}
                <strong>5% stamp duty</strong> on the purchase price or market
                value (whichever is higher). This is paid in two stages:
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 not-prose my-8">
                <div className="p-6 bg-primary/5 rounded-xl border border-primary/20">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Due within <strong>21 days</strong> of signing the
                    preliminary Promise of Sale (Konvenju) agreement.
                  </p>
                </div>
                <div className="p-6 bg-secondary/5 rounded-xl border border-secondary/20">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Due upon the <strong>final deed transfer</strong> of the
              ...
              <div className="overflow-x-auto not-prose my-6">
                <table className="w-full border-collapse text-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-border p-3">€500,000</td>
                      <td className="border border-border p-3 text-right">
                        €5,000
                      </td>
                      <td className="border border-border p-3 text-right">
            ...
            <section id="first-time-buyer" className="mt-12">
              ...
              <div className="p-6 bg-green-500/10 rounded-xl not-prose my-6 border border-green-500/20">
                ...
                <p className="text-muted-foreground">
                  First-time buyers are <strong>exempt from stamp duty</strong>{" "}
                  on the first €200,000 of the property value. Only amounts
                  exceeding €200,000 are subject to the 5% stamp duty.
                </p>
              </div>
            ...
            <section id="sda" className="mt-12">
              ...
              <p>
                Properties within SDAs have fewer restrictions for foreign
                buyers:
              </p>
              <ul>
                <li>
                  <strong>No AIP permit required</strong>
                </li>
            ...
            <section id="mortgage-requirements" className="mt-12">
              ...
              <p>
                When applying for a mortgage as an expat, banks typically
                require:
              </p>
              <ul>
                <li>
                  <strong>Higher Deposit:</strong> 20-30% (compared to 10% for
                  residents)
                </li>
                <li>
                  <strong>LTV:</strong> Maximum 70-80% Loan-to-Value
                </li>
            ...
            <div className="mt-16 p-8 bg-gradient-to-br from-amber-500/10 to-primary/5 rounded-3xl border border-border/50 not-prose text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-secondary text-white font-semibold hover:bg-secondary/90 transition-colors"
                >
