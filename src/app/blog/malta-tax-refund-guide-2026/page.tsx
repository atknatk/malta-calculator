...
export const metadata: Metadata = {
    ...defaultMetadata,
    title: "Malta Tax Refund 2026: How to Claim Back Overpaid Tax | Malta Calculator",
    description: "Malta tax refund guide 2026. Learn how to claim back overpaid income tax, FS3/FS7 forms, online submission process, and expected refund timelines.",
    keywords: ["Malta tax refund", "Malta overpaid tax", "Malta IRD refund", "Malta FS3 form", "Malta tax return"],
    alternates: { canonical: `${SITE_URL}/blog/malta-tax-refund-guide-2026` },
    openGraph: { ...ogMetadata, title: "Malta Tax Refund 2026: How to Claim Back", url: `${SITE_URL}/blog/malta-tax-refund-guide-2026`, type: "article" },
    twitter: { ...twitterMetadata, title: "Malta Tax Refund 2026: How to Claim Back" },
};
    ...
    return (
        <MarketingLayout>
            ...
            <BreadcrumbJsonLd items={[
                ...
                { name: "Tax Refund Guide", url: `${SITE_URL}/blog/malta-tax-refund-guide-2026` },
            ]} />
            <main role="main">
                    ...
                    <article className="prose prose-neutral dark:prose-invert max-w-none">
                        <header className="mb-12 not-prose">
                            <div className="flex items-center gap-3 mb-4">
                                <span className="px-3 py-1 bg-green-500/10 text-green-600 text-sm font-semibold rounded-full">Tax Guide</span>
                            ...
                            <h1 className="font-cal text-4xl md:text-5xl font-bold mb-6">Malta Tax Refund 2026: How to Claim Back Overpaid Tax</h1>
                        ...
                        <section id="process" className="mt-12">
                            ...
                            <ol>
                                <li><strong>Collect your FS3</strong> - Your employer provides this by end of February</li>
                                <li><strong>File online</strong> - Use the IRD CFR portal at cfr.gov.mt</li>
                                <li><strong>Submit by June 30</strong> - Deadline for previous year returns</li>
                                <li><strong>Wait for assessment</strong> - IRD will review and issue refund</li>
                            </ol>
                        </section>
                        ...
                        <section id="timeline" className="mt-12">
                            ...
                            <div className="p-6 bg-muted/30 rounded-xl not-prose">
                                <ul className="space-y-2 text-sm">
                                    <li>• <strong>FS3 received:</strong> By end of February</li>
                                    <li>• <strong>Filing deadline:</strong> June 30</li>
                                    <li>• <strong>Processing time:</strong> 2-6 months typically</li>
                                    <li>• <strong>Refund method:</strong> Direct bank transfer</li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <div className="mt-16 p-8 bg-gradient-to-br from-primary/10 to-secondary/5 rounded-3xl border border-border/50 not-prose text-center">
                            ...
                            <h2 className="text-2xl font-cal font-bold mb-4">Check Your Tax Liability</h2>
