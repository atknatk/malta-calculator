...
export const metadata: Metadata = {
  ...defaultMetadata,
  title:
    "Malta Children's Allowance 2026: Complete Guide & Calculator | Malta Calculator",
  description:
    ...
    <MarketingLayout>
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: "Children's Allowance Guide",
            url: `${SITE_URL}/blog/malta-childrens-allowance-guide-2026`,
          },
        ]}
      />
          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            <header className="mb-12 not-prose">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Everything you need to know about Malta&apos;s Children&apos;s
                Allowance - eligibility criteria, calculation formula, income
                thresholds, payment schedules, and the child birth bonus.
              </p>
            </header>
            ...
            <nav className="p-6 bg-muted/30 rounded-2xl mb-12 not-prose">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="#rates" className="text-primary hover:underline">
            ...
            <section id="overview">
              ...
              <p>
                ...
                <strong>social security benefit</strong> provided by
                Malta&apos;s Department of Social Security to families with
                children under <strong>16 years of age</strong>. The benefit is
                designed to help families with the costs of raising children.
              </p>
              <p>
                The allowance is <strong>means-tested</strong>, meaning the
                amount you receive depends on your household income.
                Lower-income families receive higher allowances, while
                higher-income families receive a guaranteed minimum rate.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 not-prose my-8">
                ...
                <div className="p-6 bg-rose-500/10 border border-rose-500/20 rounded-2xl">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>
                      • Max rate: <strong>€27.29/week</strong>
                    </li>
                    <li>
                      • Min rate: <strong>€8.66/week</strong>
                    </li>
                    <li>
                      • Income threshold: <strong>€30,000</strong>
                    </li>
                    <li>
                      • Calculation rate: <strong>6.50%</strong>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section id="eligibility" className="mt-12">
              ...
              <p>
                To qualify for Children&apos;s Allowance in Malta, you must meet
                specific criteria:
              </p>
              ...
              <ul>
                <li>
                  Have <strong>care and custody</strong> of children under 16
                  years of age
                </li>
              ...
              <ul>
                ...
                <li>
                  A citizen of an <strong>EU Member State</strong>
                </li>
                <li>
                  A citizen of a <strong>European Social Charter</strong> member
                  country
                </li>
                <li>
                  Have <strong>refugee status</strong>
                </li>
                <li>
                  A <strong>Third Country National</strong> in employment with
                ...
                <div className="flex gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-muted-foreground mt-1">
                      If holding a Residence or Work permit, entitlement starts
                      from the 6th month of employment. Blue Card, International
                      Protection, and Humanitarian Protection holders are
                      entitled from the start of employment.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="calculation" className="mt-12">
              ...
              <p>
                The Children&apos;s Allowance is calculated based on a{" "}
                <strong>
                  formula set by the Department of Social Security
                </strong>
              ...
              <div className="p-6 bg-blue-500/10 border border-blue-500/20 rounded-2xl my-6 not-prose">
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  The rate is based on the difference between the maximum
                  acceptable income (€30,000) and your actual income. A 6.50%
                  rate is applied, then divided by 52 weeks. The result cannot
                  be lower than €8.66 or higher than €27.29 per child.
                </p>
              </div>
              ...
              <ol>
                <li>
                  <strong>Calculate Total Income:</strong> Add up all income
                  sources including employment, rental income, bank interest,
                  pensions, and other income.
                </li>
                <li>
                  <strong>Calculate Net Income:</strong> Subtract SSC
                  contributions and income tax paid (from 2025 onwards).
                </li>
                <li>
                  <strong>Apply the Formula:</strong> (€30,000 - Net Income) ×
                  0.065 ÷ 52
                </li>
                <li>
                  <strong>Apply Limits:</strong> The result is capped between
                  €8.66 (minimum) and €27.29 (maximum).
                </li>
                <li>
                  <strong>Multiply by Children:</strong> The weekly rate applies
              ...
              <div className="p-6 bg-muted/50 rounded-2xl my-6 not-prose">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    Total Income: <strong>€25,000</strong>
                  </p>
                  <p>
                    SSC Paid: <strong>€2,500</strong>
                  </p>
                  <p>
                    Tax Paid: <strong>€2,000</strong>
                  </p>
                  <p>
                    Net Income: €25,000 - €2,500 - €2,000 ={" "}
                    <strong>€20,500</strong>
                  </p>
                  <hr className="my-3 border-border/50" />
                  <p>Weekly Rate = (€30,000 - €20,500) × 0.065 ÷ 52</p>
                  <p>
                    Weekly Rate = €9,500 × 0.065 ÷ 52 ={" "}
                    <strong>€11.88 per child</strong>
                  </p>
                  <hr className="my-3 border-border/50" />
                  <p>
                    Weekly Total (2 children): €11.88 × 2 ={" "}
                    <strong>€23.76</strong>
                  </p>
                  <p>
                    Yearly Total: €23.76 × 52 = <strong>€1,235.52</strong>
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="rates" className="mt-12">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 bg-blue-500/10 text-blue-600 rounded-full text-xs">
                          Variable
                        </span>
                      </td>
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 bg-amber-500/10 text-amber-600 rounded-full text-xs">
                          Minimum
                        </span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 bg-gray-500/10 text-gray-600 rounded-full text-xs">
                          Fixed
                        </span>
                      </td>
                      <td className="py-3 px-4 font-semibold">€8.66/child</td>
              ...
              <ul>
                <li>
                  <strong>€8,170</strong> - Below this income, maximum rate
                  (€27.29) applies
                </li>
                <li>
                  <strong>€23,068</strong> - Above this, minimum rate (€8.66)
                  applies even if formula gives less
                </li>
                <li>
                  <strong>€30,000</strong> - Maximum income threshold for
            ...
            <section id="birth-bonus" className="mt-12">
              ...
              <p>
                In addition to the regular Children&apos;s Allowance, Malta
                provides a <strong>one-time bonus</strong>
              ...
              <p>
                This bonus is paid to the <strong>mother</strong> of the newborn
                child or to the adoptive parent. It is a one-time payment,
                separate from the regular Children&apos;s Allowance.
              </p>
            </section>
            ...
            <section id="payment" className="mt-12">
              ...
              <p>
                Children&apos;s Allowance is paid{" "}
                <strong>every 13 weeks (quarterly)</strong> in advance. This
                means you receive 4 payments per year:
              </p>
              ...
              <div className="p-6 bg-muted/50 rounded-2xl my-6 not-prose">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    Weekly Rate × 13 weeks = <strong>Quarterly Payment</strong>
                  </p>
                  <hr className="my-3 border-border/50" />
                  <p>
                    <strong>
                  ...
                  <p>
                    €11.25 × 2 children × 13 weeks ={" "}
                    <strong>€292.50 per quarter</strong>
                  </p>
                </div>
              </div>

              <p>
                Payments are made via <strong>bank transfer</strong> to a local
                savings or current account. The account should typically be in
                the name of the mother unless the children are in the care and
                custody of the father or another relative.
              </p>
            </section>
            ...
            <section id="changes-2025" className="mt-12">
              ...
              <p>
                Important changes came into effect from{" "}
              ...
              <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-xl my-6 not-prose">
                <div className="flex gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-muted-foreground mt-1">
                      From 2025, both Social Security Contributions (SSC) AND
                      income tax paid are deducted from your total income when
                      calculating the allowance. Previously, only SSC was
                      deducted.
                    </p>
                  </div>
                </div>
              ...
              <p>
                This change means your <strong>net income</strong> (used for
                calculation) is lower, potentially resulting in a{" "}
                <strong>higher Children&apos;s Allowance rate</strong>.
              </p>

              <h3>Children&apos;s Allowance Supplement</h3>
              <p>
                From January 2025, an additional{" "}
                <strong>Children&apos;s Allowance Supplement</strong> is
                available:
              </p>
              <ul>
                <li>
                  <strong>€165 per child per quarter</strong> (€660/year) for
                  income below €27,434
                </li>
                <li>
                  <strong>€160 per child per quarter</strong> (€640/year) for
                  income above €27,434
                </li>
              </ul>
            </section>
            ...
            <section id="how-to-apply" className="mt-12">
              ...
              <p>
                For children born in Malta, the process is{" "}
                <strong>automatically initiated</strong> by the Department of
                Social Security upon registration of the child&apos;s birth.
              </p>

              <h3>Automatic Process</h3>
              <ol>
                <li>
                  Register the child&apos;s birth with Malta&apos;s Public
              ...
              <ul>
                ...
                <li>
                  Income details for 2 years prior (e.g., 2024 income for 2026
                  allowance)
                </li>
              ...
              <div className="space-y-6 not-prose">
                <div className="p-4 bg-muted/30 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Income from 2 years prior is used. For example,
                    Children&apos;s Allowance 2026 uses your 2024 income.
                  </p>
                </div>
                ...
                <div className="p-4 bg-muted/30 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Children must be under 16 years of age to qualify for
                ...
                <div className="p-4 bg-muted/30 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">
                    You still receive the guaranteed minimum rate of €8.66 per
                    week per child. No family is excluded entirely.
                  </p>
                </div>
                ...
                <div className="p-4 bg-muted/30 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">
                    If there is joint custody, both parents should provide their
                    individual IBAN numbers and the allowance is divided
                    accordingly.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-muted-foreground">
                    Use our free calculator to estimate your potential
                    Children&apos;s Allowance based on your household income.
                  </p>
                </div>
                <Link
            ...
            <section className="mt-12">
              ...
              <ul className="text-sm">
                <li>
                  <a
                    href="https://socialsecurity.gov.mt/en/information-and-applications-for-benefits-and-services/family-benefits/childrens-allowance-annual-income-less-than-threshold/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Malta Social Security - Children&apos;s Allowance (Income
                    less than threshold)
                  </a>
                </li>
                <li>
                  <a
                    href="https://socialsecurity.gov.mt/en/information-and-applications-for-benefits-and-services/family-benefits/childrens-allowance-annual-income-exceeds-threshold/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Malta Social Security - Children&apos;s Allowance (Income
                ...
                <li>
                  <a
                    href="https://ec.europa.eu/social/main.jsp?catId=1121&langId=en&intPageId=4690"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://mysocialsecurity.gov.mt/CalculateCA.aspx"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
