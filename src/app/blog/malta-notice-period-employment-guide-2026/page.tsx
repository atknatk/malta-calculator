...
export const metadata: Metadata = {
  ...
  alternates: pageAlternates("/blog/malta-notice-period-employment-guide-2026"),
  openGraph: {
    ...ogMetadata,
    title: "Malta Notice Period 2026: Complete Guide",
    url: `${SITE_URL}/blog/malta-notice-period-employment-guide-2026`,
    type: "article",
    images: [getBlogOgImage("Malta Notice Period 2026: Complete Guide")],
  },
  twitter: {
    ...twitterMetadata,
    title: "Malta Notice Period 2026: Complete Guide",
        ...
        <Shell className="max-w-4xl py-12">
          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <BlogArticleFooter
              slug="malta-notice-period-employment-guide-2026"
              title="Malta Notice Period 2026: Complete Guide"
              ctaTitle="Calculate Your Notice Period"
              ctaLink="/calculators/notice-period"
              ctaLinkText="Try Notice Period Calculator"
            />
          </article>
        </Shell>
      </main>
