...
import { ArrowLeft, ArrowRight, Calendar, Clock, Calculator, Users, FileText, Briefcase, CheckCircle2, AlertCircle, Globe } from "lucide-react";
import { ArticleJsonLd, BreadcrumbJsonLd } from "@/components/json-ld";

export const metadata: Metadata = {
    ...defaultMetadata,
    title: "Malta Family Reunification 2026: Complete Salary Guide | Malta Calculator",
    description:
    ...
    return (
        <MarketingLayout>
            ...
            <BreadcrumbJsonLd items={[
                ...
                { name: "Family Reunification Guide", url: `${SITE_URL}/blog/malta-family-reunification-guide-2026` },
            ]} />
                    ...
                    <article className="prose prose-neutral dark:prose-invert max-w-none">
                        <header className="mb-12 not-prose">
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed">
                                Planning to bring your family to Malta? This comprehensive guide explains
                                the two main schemes for family reunification, their salary requirements,
                                and how to calculate the minimum income you need.
                            </p>
                        </header>
                        ...
                        <nav className="p-6 bg-muted/30 rounded-2xl mb-12 not-prose">
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><a href="#two-schemes" className="text-primary hover:underline">2. Two Schemes Explained</a></li>
                                <li><a href="#salary-requirements" className="text-primary hover:underline">3. Salary Requirements</a></li>
                                <li><a href="#examples" className="text-primary hover:underline">4. Calculation Examples</a></li>
                                <li><a href="#documents" className="text-primary hover:underline">5. Required Documents</a></li>
                                <li><a href="#application" className="text-primary hover:underline">6. Application Process</a></li>
                                <li><a href="#faqs" className="text-primary hover:underline">7. FAQs</a></li>
                            </ul>
                        </nav>
                        ...
                        <section id="overview">
                            <h2>1. Overview</h2>
                            <p>
                                Malta offers pathways for <strong>non-EU nationals</strong> (Third Country Nationals - TCN)
                                to bring their family members to live with them. The key requirement is demonstrating
                                sufficient income to support your family without relying on Malta&apos;s social assistance system.
                            </p>
                            <p>
                                The income requirements are based on the <strong>national average/median wage</strong>,
                                with an additional percentage for each family member you wish to sponsor.
                            </p>
                            ...
                            <div className="grid md:grid-cols-2 gap-4 not-prose my-8">
                                <div className="p-6 bg-indigo-500/10 border border-indigo-500/20 rounded-2xl">
                                    ...
                                    <h3 className="font-semibold text-lg mb-2">Who Can You Sponsor?</h3>
                        ...
                        <section id="two-schemes" className="mt-12">
                            ...
                            <p>
                                Malta has <strong>two distinct schemes</strong> for family reunification,
                                each with different salary calculation methods:
                            </p>
                            ...
                            <div className="space-y-6 not-prose my-8">
                                <div className="p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/5 border border-blue-500/20 rounded-2xl">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 className="font-semibold text-lg">Family Reunification (S.L. 217.6)</h3>
                                    </div>
                                ...
                                <div className="p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/5 border border-purple-500/20 rounded-2xl">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 className="font-semibold text-lg">Family Member Policy</h3>
                                    </div>
                                    <p className="text-muted-foreground mb-4">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            The average/median wage figures are updated periodically by the
                                            National Statistics Office (NSO). Always check with Identità Malta
                                ...
                                <table className="w-full border-collapse text-sm">
                                    <thead>
                                        <tr className="bg-muted">
                                            <th className="border border-border p-3 text-left font-semibold">Family Members</th>
                                            <th className="border border-border p-3 text-left font-semibold">Family Reunification (Gross)</th>
                                            <th className="border border-border p-3 text-left font-semibold">Family Member Policy (Net)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td className="border border-border p-3 font-medium">1 member</td>
                                            <td className="border border-border p-3">€29,971/year (€2,498/month)</td>
                                            <td className="border border-border p-3">€22,728/year (€1,894/month)</td>
                                        </tr>
                                        <tr className="bg-muted/50">
                                            <td className="border border-border p-3 font-medium">2 members</td>
                                            <td className="border border-border p-3">€34,966/year (€2,914/month)</td>
                                            <td className="border border-border p-3">€26,516/year (€2,210/month)</td>
                                        </tr>
                                        <tr>
                                            <td className="border border-border p-3 font-medium">3 members</td>
                                            <td className="border border-border p-3">€39,962/year (€3,330/month)</td>
                                            <td className="border border-border p-3">€30,304/year (€2,525/month)</td>
                                        </tr>
                                        <tr className="bg-muted/50">
                                            <td className="border border-border p-3 font-medium">4 members</td>
                                            <td className="border border-border p-3">€44,957/year (€3,746/month)</td>
                                            <td className="border border-border p-3">€34,092/year (€2,841/month)</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div className="space-y-6 not-prose my-8">
                                <div className="p-6 bg-muted/30 rounded-2xl">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <p className="pl-4">€24,976 + (€24,976 × 20%) = <strong>€29,971 gross/year</strong></p>
                                        <p className="mt-4"><strong>Family Member Policy:</strong></p>
                                        <p className="pl-4">€18,940 + (€18,940 × 20%) = <strong>€22,728 net/year</strong></p>
                                    </div>
                                </div>
                                ...
                                <div className="p-6 bg-muted/30 rounded-2xl">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        <p><strong>Family Reunification:</strong></p>
                                        <p className="pl-4">€24,976 + (€24,976 × 20% × 3) = <strong>€39,962 gross/year</strong></p>
                                        <p className="mt-4"><strong>Family Member Policy:</strong></p>
                                        <p className="pl-4">€18,940 + (€18,940 × 20% × 3) = <strong>€30,304 net/year</strong></p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="faqs" className="mt-12">
                            ...
                            <div className="space-y-4 not-prose my-8">
                                <div className="p-4 bg-muted/30 rounded-xl">
                                    <h4 className="font-semibold mb-2">Which scheme should I apply under?</h4>
                                    <p className="text-sm text-muted-foreground">
                                        Family Reunification (S.L. 217.6) is the main legal pathway. Family Member Policy
                                        is typically for specific situations. Consult Identità Malta for guidance.
                                    </p>
                                </div>
                                <div className="p-4 bg-muted/30 rounded-xl">
                                    <h4 className="font-semibold mb-2">Can I combine income with my spouse?</h4>
                                    <p className="text-sm text-muted-foreground">
                                        Generally, the sponsor must demonstrate sufficient individual income.
                                        Joint income may be considered in specific circumstances.
                                    </p>
                                </div>
                                <div className="p-4 bg-muted/30 rounded-xl">
                                    <h4 className="font-semibold mb-2">How long does the process take?</h4>
                                    <p className="text-sm text-muted-foreground">
                                        Typical processing time is 3-6 months, but can vary depending on
                                        complexity and document verification requirements.
                                    </p>
                                </div>
                                <div className="p-4 bg-muted/30 rounded-xl">
                                    <h4 className="font-semibold mb-2">Can my family work in Malta?</h4>
                                    <p className="text-sm text-muted-foreground">
                                        Family members may apply for work permits after receiving residence status.
                        ...
                        <div className="mt-16 p-8 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-violet-500/10 rounded-3xl border border-indigo-500/20 not-prose text-center">
                            ...
                            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
                                Use our Family Reunification Calculator to find out the exact minimum salary
                                you need to sponsor your family members under both schemes.
                            </p>
                            <Link
