...
export const metadata: Metadata = {
    ...defaultMetadata,
    title: "Understanding COLA in Malta 2026: Cost of Living Adjustment Guide | Malta Calculator",
    description:
                    ...
                    <article className="prose prose-neutral dark:prose-invert max-w-none">
                        <header className="mb-12 not-prose">
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed">
                                COLA is a crucial component of every salary in Malta. Learn what it is,
                                how it&apos;s calculated, and how much you&apos;ll receive in 2026.
                            </p>
                        </header>
                        ...
                        <nav className="p-6 bg-muted/30 rounded-2xl mb-12 not-prose">
                            ...
                            <ul className="space-y-2 text-sm">
                                <li><a href="#what-is-cola" className="text-primary hover:underline">1. What is COLA?</a></li>
                                <li><a href="#cola-2026" className="text-primary hover:underline">2. COLA Rates for 2026</a></li>
                                <li><a href="#how-calculated" className="text-primary hover:underline">3. How is COLA Calculated?</a></li>
                                <li><a href="#cola-history" className="text-primary hover:underline">4. COLA History (2020-2026)</a></li>
                                <li><a href="#tax-treatment" className="text-primary hover:underline">5. Tax Treatment of COLA</a></li>
                                <li><a href="#impact" className="text-primary hover:underline">6. Impact on Your Salary</a></li>
                            </ul>
                        </nav>
                        ...
                        <section id="what-is-cola">
                            ...
                            <p>
                                <strong>COLA (Cost of Living Adjustment)</strong> is a mandatory annual allowance that
                                all employers in Malta must pay to their employees. It&apos;s designed to help workers
                                keep up with inflation and maintain their purchasing power.
                            </p>
                            <p>
                                Key characteristics of COLA:
                            </p>
                            <ul>
                                <li><strong>Universal</strong> - Every employee receives it, regardless of salary level</li>
                                <li><strong>Flat rate</strong> - The same amount for everyone (not percentage-based)</li>
                                <li><strong>Annual increase</strong> - Adjusted each year based on inflation</li>
                                <li><strong>Tax-free</strong> - Not subject to income tax</li>
                                <li><strong>Cumulative</strong> - Each year&apos;s COLA is added to the previous total</li>
                            </ul>
                        </section>
                        ...
                        <section id="cola-2026" className="mt-12">
                            ...
                            <div className="p-8 bg-gradient-to-br from-emerald-500/10 to-green-500/5 rounded-3xl border border-emerald-500/20 not-prose my-8 text-center">
                                ...
                                <div className="text-4xl font-bold text-emerald-600 mb-2">€10.36</div>
                                <div className="text-lg text-muted-foreground mb-4">per week (2026 increase)</div>
                                <div className="grid grid-cols-2 gap-4 max-w-md mx-auto text-sm">
                                    ...
                                    <div className="p-4 bg-white/50 dark:bg-white/5 rounded-xl">
                                        ...
                                        <div className="text-xl font-bold text-primary">€538.72</div>
                                    </div>
                                </div>
                            </div>

                            <p>
                                For 2026, the COLA increase is <strong>€10.36 per week</strong>, which translates to
                                approximately <strong>€538.72 per year</strong>. This is added to the cumulative COLA
                                from previous years.
                            </p>
                        </section>
                        ...
                        <section id="how-calculated" className="mt-12">
                            ...
                            <p>
                                COLA is calculated by the government based on the <strong>Retail Price Index (RPI)</strong>,
                                which measures the change in prices of goods and services consumed by households.
                            </p>
                            <p>
                                ...
                                <table className="w-full border-collapse text-sm">
                                    <thead>
                                        <tr className="bg-muted">
                                            ...
                                            <th className="border border-border p-3 text-left font-semibold">Weekly Increase</th>
                                            <th className="border border-border p-3 text-left font-semibold">Annual Increase</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="border border-border p-3 text-xs text-muted-foreground">Pre-pandemic levels</td>
                                        </tr>
                                        <tr className="bg-muted/50">
                                            <td className="border border-border p-3">2021</td>
                                            <td className="border border-border p-3">€1.75</td>
                                            <td className="border border-border p-3">€91.00</td>
                                            <td className="border border-border p-3 text-xs text-muted-foreground">COVID-19 impact</td>
                                        </tr>
                                        <tr>
                                            <td className="border border-border p-3">2022</td>
                                            <td className="border border-border p-3">€1.75</td>
                                            <td className="border border-border p-3">€91.00</td>
                                            <td className="border border-border p-3 text-xs text-muted-foreground">Government price caps</td>
                                        </tr>
                                        <tr className="bg-muted/50">
                                            ...
                                            <td className="border border-border p-3 text-xs text-muted-foreground">High inflation year</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="border border-border p-3 text-xs text-muted-foreground">Continued adjustments</td>
                                        </tr>
                                        <tr className="bg-muted/50">
                                            ...
                                            <td className="border border-border p-3 text-xs text-muted-foreground">Stabilizing inflation</td>
                                        </tr>
                                        <tr className="bg-emerald-500/10">
                                            <td className="border border-border p-3 font-semibold">2026</td>
                                            <td className="border border-border p-3 font-semibold text-primary">€10.36</td>
                                            <td className="border border-border p-3 font-semibold text-primary">€538.72</td>
                                            <td className="border border-border p-3 text-xs font-medium">Current year</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <section id="tax-treatment" className="mt-12">
                            ...
                            <p>
                                One of the key benefits of COLA is that it is <strong>completely tax-free</strong>.
                                This means:
                            </p>
                            <ul>
                                <li>COLA is <strong>not subject to income tax</strong></li>
                                <li>It does <strong>not count toward your taxable income</strong></li>
                            ...
                            <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-xl not-prose">
                                <p className="text-sm">
                                    <strong>✅ Tax-Free Benefit:</strong> Your €538.72 annual COLA for 2026 is yours to keep
                                    in full — it&apos;s not taxed and doesn&apos;t push you into a higher tax bracket.
                                </p>
                            </div>
                        </section>
                        ...
                        <section id="impact" className="mt-12">
                            ...
                            <div className="p-6 bg-muted/30 rounded-xl not-prose my-4">
                                <ul className="space-y-2 text-sm">
                                    ...
                                    <li>• Total gross: <strong>€25,538.72</strong></li>
                                    <li className="pt-2 border-t border-border">
                                        <span>Taxable portion: </span>
                                        <strong className="text-primary">€25,000</strong>
                                        <span className="text-muted-foreground text-xs"> (COLA is tax-free)</span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="mt-16 p-8 bg-gradient-to-br from-primary/10 to-secondary/5 rounded-3xl border border-border/50 not-prose text-center">
                            ...
                            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
                                Our Malta Salary Calculator shows exactly how COLA affects your net salary,
                                with a detailed breakdown of all components.
                            </p>
                            <Link
                                href="/salary"
