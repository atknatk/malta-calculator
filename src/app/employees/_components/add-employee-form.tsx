...
export default function AddEmployeeForm() {
  ...
  const inputClassName =
    "w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white dark:placeholder-slate-500";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      >
        ...
        <span>
          {showAdvanced ? "Hide" : "Show"} Professional Payslip Fields
        </span>
      </button>
      ...
      {showAdvanced && (
        <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/50">
          <p className="text-xs text-slate-500 dark:text-slate-400">
            These fields appear on professional payslips (matching INDIGO
            format)
          </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, ssNumber: e.target.value })
                }
