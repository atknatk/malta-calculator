...
const changelogEntries: ChangelogEntry[] = [
  ...
  },
  {
    ...
    description:
      "New shareable countdown timer tool and comprehensive SEO improvements for better discoverability.",
    features: [
  ...
  },
  {
    ...
    description:
      "Complete payslip verification system, company settings with logo management, and enhanced document generation.",
    features: [
  ...
  },
  {
    ...
    description:
      "Complete Transport Malta vehicle-related calculators and 2026 regulations.",
    features: [
  ...
  },
  {
    ...
    description:
      "Comprehensive Malta banking and loan calculators with local regulations.",
    features: [
  ...
  },
  {
    ...
    description:
      "Malta employment law calculators based on official DIER regulations.",
    features: [
  ...
  },
  {
    ...
    icon: <Sparkles className="w-5 h-5" />,
    description:
      "Complete redesign with premium aesthetics and server-side rendering.",
    features: [
          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Track all updates, new features, and improvements to Malta
                Calculator. We&apos;re constantly adding new calculators and
                ...
                return (
                  ...
                  >
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      ...
                      <span
                        className={`px-3 py-1 ${styles.badge} text-sm font-semibold rounded-full`}
                      >
                        {entry.version}
                      </span>
            ...
            <section className="mt-12 p-8 bg-gradient-to-br from-primary/5 via-background to-secondary/5 rounded-2xl border border-primary/10">
              ...
              <p className="text-muted-foreground mb-4">
                We&apos;re actively working on new calculators and features
