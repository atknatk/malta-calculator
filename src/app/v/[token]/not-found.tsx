...
export default function ShortVerifyNotFound() {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-md text-center">
          ...
          <p className="text-slate-500 mb-6">
            The payslip you are looking for could not be verified. This may be
            because the link is invalid or the payslip has been removed.
          </p>
          ...
          <p className="text-sm text-slate-500 mb-6">
            If you believe this is an error, please contact the employer who
            issued the payslip.
          </p>
