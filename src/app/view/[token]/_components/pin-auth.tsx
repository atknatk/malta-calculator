...
export default function PinAuth({ payslipId, employeeName, token }: PinAuthProps) {
        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
            <div className="mx-4 w-full max-w-md rounded-2xl bg-white p-8 shadow-xl dark:bg-slate-800">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                            Enter your date of birth as DDMMYYYY (e.g., 15th March 1990 = 15031990)
                        </p>
                    </div>
                ...
                <p className="mt-6 text-center text-xs text-slate-500">
                    This link was sent to you by your employer. If you didn&apos;t request this, please contact them.
                </p>
            </div>
        </div>
    );
