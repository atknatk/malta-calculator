...
export default function PayslipViewer({ payslip }: PayslipViewerProps) {
  ...
  const totalDeductions =
    payslip.deductions.incomeTax + payslip.deductions.sscEmployee;
          ...
          <div className="rounded-2xl border bg-white shadow-xl print:rounded-none print:border-0 print:shadow-none dark:bg-slate-800 dark:border-slate-700">
            ...
            <div className="border-b border-slate-200 p-6 dark:border-slate-700">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between p-2">
                  ...
                  <span className="font-medium text-red-600">
                    -€{payslip.deductions.sscEmployee.toFixed(2)}
                  </span>
                </div>
            ...
            <div className="p-6">
              ...
              <p className="mt-4 text-center text-xs text-slate-400">
                Generated on{" "}
                {new Date(payslip.created_at).toLocaleDateString("en-GB", {
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                })}
