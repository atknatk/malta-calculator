...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log(`📋 Facebook data deletion request received for user: ${userId}`);
...
export async function GET() {
    return NextResponse.json({
        ...
        method: 'POST',
        description: 'This endpoint handles Facebook user data deletion requests as per Facebook Platform Terms.',
    });
}
