                    ...
                    <div className="p-6 rounded-3xl bg-gradient-to-br from-primary/10 via-primary/5 to-secondary/10 border border-primary/20 space-y-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center p-3 rounded-xl bg-background/50">
                                <span className="text-sm text-muted-foreground">Base Entitlement</span>
                                <span className="font-semibold">{result.baseHours}h ({result.baseHours / 8} days)</span>
                            </div>
                            <div className="flex justify-between items-center p-3 rounded-xl bg-background/50">
                                <span className="text-sm text-muted-foreground">Public Holiday Additions</span>
                                <span className="font-semibold text-green-600">+{result.publicHolidayHours}h</span>
                            </div>
                            <div className="flex justify-between items-center p-3 rounded-xl bg-primary/10 border border-primary/20">
                                ...
                                <span className="font-bold text-primary">{result.totalHours}h</span>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="text-sm">
                                ...
                                <p className="text-muted-foreground text-xs">
                                    {holidayInfo.note}. These add {holidayInfo.extraHours}h to your entitlement.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="text-sm text-muted-foreground">
                                ...
                                <ul className="list-disc list-inside space-y-1 text-xs">
                                    ...
                                    <li>Up to 50% of unused leave may carry over (with approval)</li>
