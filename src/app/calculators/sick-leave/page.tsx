...
export const metadata: Metadata = {
    ...
    description: "Malta hastalık izni hesaplayıcı. Hastalık izni süresi ve ödeme hesaplama. Calculate sick leave entitlement in Malta.",
...
export default function SickLeavePage() {
    return (
        <ComingSoonPage
            ...
            titleTr="Hastalık İzni Hesaplayıcı"
            description="Calculate sick leave entitlement and sickness benefit payments in Malta."
            descriptionTr="Malta'daki hastalık izni hakkını ve hastalık yardımı ödemelerini hesaplayın."
            ...
            featuresTr={[
                "İşveren tarafından ödenen hastalık izni",
                "SSC tarafından finanse edilen hastalık yardımı",
                "Sağlık raporu gereksinimleri",
                "Maksimum yardım süreleri",
            ]}
        />
    );
}
