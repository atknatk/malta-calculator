...
export const metadata: Metadata = {
    ...
    description: "Malta ilk ev alımı hesaplayıcı. İlk kez ev alıcıları için teşvik ve indirimler. Calculate first-time buyer benefits in Malta.",
...
export default function FirstTimeBuyerPage() {
    return (
        <ComingSoonPage
            ...
            titleTr="İlk Ev Alımı Hesaplayıcı"
            ...
            descriptionTr="Damga vergisi indirimleri ve hibeler dahil Malta'da ilk kez mülk alıcılarına sunulan avantajları hesaplayın."
            ...
            featuresTr={[
                "İndirimli damga vergisi (%3.5)",
                "Mülk değeri limitleri",
                "Hibe uygunluğu",
