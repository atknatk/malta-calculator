        ...
        questions={[
          {
            ...
            answer:
              "Children's Allowance is awarded to married couples, civil union couples, cohabiting couples, single parents, or separated parents having care and custody of children under 16 years of age and whose household income meets the eligibility criteria.",
          },
          {
            question: "What is the maximum Children's Allowance rate in Malta?",
            answer:
              "The maximum weekly rate per child is €27.29, which applies when household net income is below €8,170. The minimum guaranteed rate is €8.66 per week per child.",
          },
          {
            question: "How is Children's Allowance calculated in Malta?",
            answer:
              "The rate is calculated based on the difference between €30,000 (maximum income threshold) and your actual net income. A 6.50% rate is applied to this difference, divided by 52 weeks. SSC and income tax are deducted from total income.",
          },
          {
            question: "How often is Children's Allowance paid in Malta?",
            answer:
              "Children's Allowance is paid every 13 weeks (quarterly) in advance.",
          },
          {
            question: "What is the Child Birth Bonus in Malta?",
            answer:
              "Malta provides a one-time birth/adoption bonus: €1,000 for the first child, €1,500 for the second child, and €2,000 for the third child and beyond.",
          },
        ]}
      />
