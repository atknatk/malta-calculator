    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Calculate your statutory retirement age based on Malta&apos;s Social
          Security Act.
        </p>
      </motion.div>
            ...
            <div className="space-y-3">
              <label className="text-sm font-medium text-foreground/70">
                ...
                {birthYear > 1951 && (
                  <span className="text-muted-foreground ml-2">
                    (not applicable for your birth year)
                  </span>
                )}
              </label>
              <ToggleGroup
              ...
              {birthYear <= 1951 && (
                <p className="text-xs text-muted-foreground">
                  For those born 1951 or earlier, retirement age differs by
                  gender.
                </p>
              )}
            </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground text-xs">
                    You may retire at 61 if you have at least 35 years of
                    contributions and are not in gainful employment until your
              ...
              {brackets.map((bracket, i) => (
                <tr
                  ...
                  className={cn(
                    ...
                    result.ruleDescription.includes(
                      bracket.birthYears.split(" ")[0],
                    )
                      ? "bg-primary/5"
                      : "hover:bg-muted/30",
                  )}
