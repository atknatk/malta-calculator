...
export function SavingsCalculator() {
  ...
  const [interestRate, setInterestRate] = useState<number>(
    SAVINGS_CONSTANTS.DEFAULT_INTEREST_RATE,
  );
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Calculate compound interest on your savings with Malta&apos;s 15%
          withholding tax.
        </p>
      </motion.div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center p-3 rounded-xl bg-emerald-500/5">
                ...
                <span className="font-semibold text-emerald-600">
                  +{formatCurrency(result.totalInterestGross)}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
                ...
                <span className="font-semibold text-emerald-600">
                  {formatCurrency(result.totalInterestNet)}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-1 text-xs">
                  <li>
                    <strong>15%</strong> final withholding tax on interest
                    income
                  </li>
