...
export const metadata: Metadata = {
    ...
    description: "Calculate the total cost of importing a vehicle to Malta. Includes registration tax, import duty, VAT, shipping, and all fees.",
    alternates: { canonical: `${SITE_URL}/calculators/import-vehicle` },
    openGraph: { ...ogMetadata, title: "Import Vehicle Calculator Malta", url: `${SITE_URL}/calculators/import-vehicle` },
