...
export const metadata: Metadata = {
  ...
  description:
    "Calculate minimum salary requirements for family reunification in Malta. Two schemes explained: Family Reunification (S.L. 217.6) and Family Member Policy with salary thresholds.",
  keywords: [
        ...
        questions={[
          {
            ...
            answer:
              "For Family Reunification (S.L. 217.6), you need the average gross wage (€24,976/year in 2025) plus 20% for each family member. For Family Member Policy, you need €18,940 net plus 20% of median wage per family member.",
          },
          {
            question:
              "What is the difference between Family Reunification and Family Member Policy?",
            answer:
              "Family Reunification (S.L. 217.6) requires gross income based on average wage, while Family Member Policy requires net income. Family Reunification is the main legal pathway, while Family Member Policy is for specific cases.",
          },
          {
            question:
              "How much salary do I need to sponsor 2 family members in Malta?",
            answer:
              "For 2 family members under Family Reunification, you need approximately €34,966 gross per year (€2,914/month). Under Family Member Policy, you need €26,516 net per year (€2,210/month).",
          },
          {
            question: "Who can I sponsor for family reunification in Malta?",
            answer:
              "You can sponsor your spouse or registered partner, minor children (under 18), adult dependent children, and in some cases, dependent parents.",
          },
        ]}
      />
