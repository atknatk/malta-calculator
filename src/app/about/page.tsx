          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>
                  <strong>Salary Calculator:</strong> Calculate your net salary
                  with accurate 2024-2026 tax brackets, SSC contributions, and
                  COLA adjustments
                </li>
                <li>
                  <strong>Multi-Year Support:</strong> Compare calculations
                  across different tax years (2024, 2025, 2026)
                </li>
                <li>
                  <strong>Tax Type Options:</strong> Single, Married, and Parent
                  tax rate calculations
                </li>
                <li>
                  <strong>SSC Categories:</strong> Full support for Category A,
                  B, and C with automatic age-based regime detection
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                January to reflect new budget changes.
              </p>
            </section>
