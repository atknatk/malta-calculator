          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <section className="mb-10 pb-8 border-b border-border/50">
              ...
              <p className="text-muted-foreground leading-relaxed">
                At Malta Calculator, we respect your privacy and are committed
                to protecting your personal data. This Privacy Policy explains
                how we collect, use, disclose, and safeguard your information
                when you visit our website.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
                This policy applies to all users of Malta Calculator and
                complies with the General Data Protection Regulation (GDPR) and
              ...
              <p className="text-muted-foreground leading-relaxed mt-4 p-4 bg-muted/30 rounded-lg border-l-4 border-primary/50">
                <strong>🇲🇹 Malti:</strong> F&apos;Malta Calculator, nirrispettaw
                il-privatezza tiegħek u nimpenjaw ruħna li nipproteġu d-data
                personali tiegħek. Din il-Politika ta&apos; Privatezza tispjega
                kif niġbru, nużaw, u nipproteġu l-informazzjoni tiegħek.
              </p>
            </section>
            ...
            <section className="mb-10 pb-8 border-b border-border/50">
              ...
              <p className="text-muted-foreground leading-relaxed">
                When you visit our website, we automatically collect anonymous
                usage data through Google Analytics 4, including:
              </p>
              ...
              <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
                <p className="text-emerald-700 dark:text-emerald-300">
                  ✅ <strong>Important:</strong> Salary, tax, and financial
                  information you enter into our calculators is{" "}
                  <strong>NOT stored on our servers</strong>. All calculations
                  are performed:
                </p>
                <ul className="list-disc list-inside text-emerald-700 dark:text-emerald-300 mt-2 ml-4 space-y-1">
                  ...
                  <li>
                    As stateless server-side operations (no data retention)
                  </li>
                </ul>
              </div>
              ...
              <h3 className="text-lg font-semibold mt-6 mb-3">
                2.4 Google Sign-In Authentication
              </h3>
              <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg mb-4">
                <p className="text-blue-700 dark:text-blue-300">
                  🔐 <strong>Google Authentication:</strong> When you sign in
                  with Google for event registration, we receive and store:
                </p>
              </div>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
                  <strong>Email address:</strong> Used to identify your account
                  and send event confirmations
                </li>
                <li>
                  <strong>Display name:</strong> Used to personalize your
                  experience
                </li>
                <li>
                  <strong>Profile picture URL:</strong> Used to display your
                  avatar (optional)
                </li>
                <li>
                  <strong>Google User ID:</strong> Used for secure account
                  identification
                </li>
              </ul>
              ...
              <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
                <p className="text-emerald-700 dark:text-emerald-300 mb-2">
                  ✅ Malta Calculator&apos;s use and transfer of information
                ...
                <p className="text-emerald-700 dark:text-emerald-300 text-sm">
                  We only use Google data for authentication and event
                  registration purposes. We do not share your Google data with
            ...
            <section className="mb-10 pb-8 border-b border-border/50">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                <strong>Legal Basis (GDPR Article 6):</strong> We process data
                based on legitimate interests (website improvement and security)
                and, where applicable, your consent for analytics cookies.
              </p>
            </section>
            ...
            <section className="mb-10 pb-8 border-b border-border/50">
              ...
              <div className="mt-4 space-y-4">
                <div className="p-4 bg-muted/30 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Required for basic website functionality, theme preference,
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                <strong>Managing Cookies:</strong> You can disable cookies
                through your browser settings. Note that disabling essential
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Website hosting and deployment (USA/EU)
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Website analytics with IP anonymization enabled
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-blue-500/10 rounded-lg border border-blue-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Secure authentication for event registration. We receive
                      only basic profile information (email, name, profile
                      photo).
                    </p>
            ...
            <section className="mb-10 pb-8 border-b border-border/50">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-4 ml-4">
                <li>
                  <strong>HTTPS Encryption:</strong> All data transmitted is
                  encrypted via TLS/SSL
                </li>
                <li>
                  <strong>No Financial Data Storage:</strong> We don&apos;t
                  store sensitive calculation inputs
                </li>
                <li>
                  <strong>Secure Hosting:</strong> Enterprise-grade
            ...
            <section className="mb-10 pb-8 border-b border-border/50">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                ...
                . The Malta supervisory authority is the Information and Data
            ...
            <section className="mb-10 pb-8 border-b border-border/50">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
                  <strong>Calculator inputs:</strong> Not retained (processed in
                  real-time only)
                </li>
                <li>
                  <strong>Analytics data:</strong> 14 months (Google Analytics
                  default)
                </li>
                <li>
                  <strong>Server logs:</strong> 30 days (security purposes)
                </li>
              </ul>
            </section>
            ...
            <section className="mb-10 pb-8 border-b border-border/50">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Some third-party services may transfer data outside the European
                Economic Area (EEA). Where this occurs, we ensure appropriate
            ...
            <section className="mt-8 p-6 bg-gradient-to-br from-emerald-500/5 via-background to-blue-500/5 rounded-2xl border border-emerald-500/10 text-center">
              ...
              <p className="text-muted-foreground mb-2">
                Your privacy matters. We are committed to transparency and data
                protection.
              </p>
              <p className="text-sm text-muted-foreground">
                Policy version: 2.0 | © 2024-2026 Malta Calculator
              </p>
            </section>
          </article>
        </Shell>
